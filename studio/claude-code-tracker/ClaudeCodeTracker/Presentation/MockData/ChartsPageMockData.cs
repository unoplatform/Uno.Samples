...
public static class ChartsPageMockData
{
    public static ChartsData Data { get; } = new(
        ...
        {
            new PieSeries<double> { Name = "Input",       Values = new double[] { 60.3 }, InnerRadius = 50 },
            new PieSeries<double> { Name = "Output",      Values = new double[] { 14.0 }, InnerRadius = 50 },
            new PieSeries<double> { Name = "Cache Read",  Values = new double[] { 20.4 }, InnerRadius = 50 },
            new PieSeries<double> { Name = "Cache Write", Values = new double[] { 5.3 },  InnerRadius = 50 },
        },
        ModelShareSeries: new ISeries[]
        {
            new PieSeries<double> { Name = "Opus",   Values = new double[] { 55.7 }, InnerRadius = 50 },
            new PieSeries<double> { Name = "Sonnet", Values = new double[] { 33.9 }, InnerRadius = 50 },
            new PieSeries<double> { Name = "Haiku",  Values = new double[] { 10.4 }, InnerRadius = 50 },
        },
