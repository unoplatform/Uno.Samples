...
<!-- This list supports both the main Uno Platform Documentation (incorporated into doc/samples.md) and the README.md of this repository, ensuring consistency across documents. The synchronization process is automated through the script located at build/stage-update-readme-samples-list.yml.
Whenever this list here is modified, the CI build associated with the corresponding pull request will automatically synchronize the updates with README.md.
...
IMPORTANT: The automated inclusion process begins right after this notice. Please maintain the structure and logic of the current headings to ensure coherence both in the general Uno Platform documentation and the README.md of this repository. -->
