...
internal enum FlowStepKind
{
    ...
    /// <summary>An MSAL API call is about to be made.</summary>
    Call,
...
/// <summary>
/// Ordered, observable narration of what MSAL is doing. Bound directly to a
/// <see cref="Microsoft.UI.Xaml.Controls.ItemsControl"/> so the sign-in flow is visible
/// step by step on every platform.
/// </summary>
internal sealed class AuthFlowLog : ObservableCollection<FlowStep>
{
