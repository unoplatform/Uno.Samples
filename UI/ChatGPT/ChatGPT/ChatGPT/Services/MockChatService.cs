...
//The MockChatService will be used instead of the ChatResponse if an API Key isn't provided in appsettings.json
public class MockChatService : IChatService
{
	//Hard-coded responses to simulate AI's responses
