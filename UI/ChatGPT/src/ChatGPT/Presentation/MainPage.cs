...
public sealed partial class MainPage : Page
{
	...
	private static ToggleButton Header(BindableMainModel vm)
		=> new ToggleButton()
	...
	private static UIElement Messages(BindableMainModel vm)
		=> new ListView()
			.Grid(row: 1)
	...
	private static Grid Prompt(BindableMainModel vm)
		=> new Grid()
			.Grid(row: 2)
