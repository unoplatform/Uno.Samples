...
namespace StatusBarColorSample
{
    ...
    public sealed partial class App : Application
    {
        ...
        private void UpdateStatusBar()
        {
			...
			{
				commandBar.Foreground = new Microsoft.UI.Xaml.Media.SolidColorBrush(foreground); // controls the color for the "MainPage" page title
				commandBar.Background = new Microsoft.UI.Xaml.Media.SolidColorBrush(background);
			}
#endif
        }
