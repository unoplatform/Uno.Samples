...
using UnoChat.Models;


namespace UnoChat.Presentation;
...
public class ViewModel : INotifyPropertyChanged
{
    ...
    private readonly MVx.Observable.Property<Model> _lastMessageReceived;
    ...
    private readonly ObservableCollection<Model> _allMessages;

    private readonly HubConnection _connection;

    public event PropertyChangedEventHandler PropertyChanged;
    private static string DefaultName => RuntimeInformation.OSDescription.Length > 20 ? RuntimeInformation.OSDescription.Substring(0, 20) + "..." : RuntimeInformation.OSDescription;
    ...
    public ViewModel()
    {
        ...
        _lastMessageReceived = new MVx.Observable.Property<Model>(nameof(LastMessageReceived), args => PropertyChanged?.Invoke(this, args));
    ...
    private IDisposable ShouldSendModelsAddedToAllMessagesToMessageObserver(IObserver<Model> messageObserver)
    {
        return Observable
            ...
            .Select(args => args.NewItems.OfType<Model>().FirstOrDefault())
    ...
    public IDisposable Activate(IObservable<object> messageToSendBoxReturn, IObserver<string> themeObserver, IObserver<Model> messageObserver)
    {
    ...
    public Model LastMessageReceived => _lastMessageReceived.Get();

    public IEnumerable<Model> AllMessages => _allMessages;
