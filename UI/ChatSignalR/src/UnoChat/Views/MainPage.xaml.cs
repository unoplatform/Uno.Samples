...
using UnoChat.Presentation;

// The Blank Page item template is documented at http://go.microsoft.com/fwlink/?LinkId=402352&clcid=0x409

namespace UnoChat.Views;
...
public sealed partial class MainPage : Page
{
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        var messageToSendReturn = Observable
            .FromEvent<Microsoft.UI.Xaml.Input.KeyEventHandler, KeyRoutedEventArgs>(
        ...
        var scroller = Observer.Create<Model>(model => MessagesListView.ScrollIntoView(model));
