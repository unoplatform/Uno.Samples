...
namespace PharmaSupply.Contracts.Wholesaler
{
    public partial class WholesalerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, WholesalerDeployment wholesalerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<WholesalerDeployment>().SendRequestAndWaitForReceiptAsync(wholesalerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, WholesalerDeployment wholesalerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<WholesalerDeployment>().SendRequestAsync(wholesalerDeployment);
        }

        public static async Task<WholesalerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, WholesalerDeployment wholesalerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, wholesalerDeployment, cancellationTokenSource);
            return new WholesalerService(web3, receipt.ContractAddress);
        }
        ...
        public WholesalerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
