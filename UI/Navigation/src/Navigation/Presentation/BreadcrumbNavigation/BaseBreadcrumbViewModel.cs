...
public partial class BaseBreadcrumbViewModel : ObservableObject
{
	private readonly IRouteNotifier _notifier;
	private readonly INavigator _navigator;

	[ObservableProperty]
	private ICollection<string> _breadcrumbs = new ObservableCollection<string>();

	protected BaseBreadcrumbViewModel(IRouteNotifier notifier, INavigator navigator)
	{
		_notifier = notifier;
