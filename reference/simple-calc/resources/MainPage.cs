...
public sealed partial class MainPage : Page
{
    public MainPage()
    {
        this.DataContext(new DataContextClass(this.GetThemeService()), (page, vm)
            ...
            //.Add(AppIcons.Dark)
            //.Add(AppIcons.Light)
            //.Add<Geometry>("SunIcon", AppIcons.LightIcon)
            //.Add<Geometry>("MoonIcon", AppIcons.DarkIcon)
            .Add("SunIcon", AppIcons.LightIcon)
            .Add("MoonIcon", AppIcons.DarkIcon)
            )
