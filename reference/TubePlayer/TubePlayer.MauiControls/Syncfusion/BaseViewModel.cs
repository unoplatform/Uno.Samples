...
namespace SyncfusionApp.MauiControls.Samples.CircularChart.SfCircularChart
{
    public class BaseViewModel : INotifyPropertyChanged
    {
        ...
        public BaseViewModel()
        {
            ...
            {
                new SolidColorBrush(Color.FromArgb("#67E5AD")),
                new SolidColorBrush(Color.FromArgb("#F85977")),
                new SolidColorBrush(Color.FromArgb("#7A67F8")),
                new SolidColorBrush(Color.FromArgb("#159BFF")),
