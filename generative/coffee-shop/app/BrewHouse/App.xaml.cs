...
public partial class App : Application
{
    ...
    private static void RegisterRoutes(IViewRegistry views, IRouteRegistry routes)
    {
        views.Register(
            ...
            new ViewMap<HomePage>(ViewModel: typeof(HomeViewModel)),
            new ViewMap<MenuPage>(ViewModel: typeof(MenuViewModel)),
            new ViewMap<CartPage>(ViewModel: typeof(CartViewModel)),
            new ViewMap<OrdersPage>(ViewModel: typeof(OrdersViewModel))
        );
